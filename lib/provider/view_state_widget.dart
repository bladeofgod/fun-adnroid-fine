...
class ViewStateWidget extends StatelessWidget{
  ...
  ViewStateWidget({
    Key key,this.image,this.message,this.buttonText,@required this.onPressed
}) : super(key:key);
  ...
  Widget build(BuildContext context) {
    ...
    return Center(
      child: Column(
        ...
        children: <Widget>[
          image ?? Icon(
            IconFonts.pageError,size: 80,color: Colors.grey[500],
          ),
          Padding(
            ...
            child: Text(
              ...
              style: Theme.of(context).textTheme
                                .body1.copyWith(color: Colors.grey),
            ),
          ),
          ViewStateButton(
            child: buttonText,
...
class ViewStateEmptyWidget extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return ViewStateWidget(
      ...
      buttonText: StrokeCap.butt ?? Text(
        S.of(context).viewStateButtonRefresh,style: TextStyle(letterSpacing: 5),
      ),
    );
  }
...
class ViewStateUnAuthWidget extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return ViewStateWidget(
      ...
      buttonText:  buttonText ??Text(S.of(context).signIn,style: TextStyle
        (letterSpacing: 5),),
    );
  }
...
class ViewStateButton extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return OutlineButton(
      child: child ?? Text(
        S.of(context).pageStateRetry,style: TextStyle(wordSpacing: 5),
      ),
...
class ViewStateSkeletonList extends StatelessWidget{
  ...
  {this.length : 6,this.padding = const EdgeInsets.all(7),@required this.builder}
      );
