...
class WanAndroidRepository{
  ...
  static Future fetchArticles(int pageNum,{int cid}) async{
    ...
    return response.data['datas']
        .map<Article>((item) => Article.fromMap(item)).toList();
  }
