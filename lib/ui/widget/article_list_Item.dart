...
import 'package:flutter_app_funandroid/ui/helper/favourite_helper.dart';
    ...
    return Stack(
      children: <Widget>[
                    ...
                    children: <Widget>[
                      ClipOval(
                        child: CachedNetworkImage(
                          ...
                          placeholder: (_,__)=>ImageHelper.placeHolder(width:
                          20,height: 20),
                          errorWidget: (_,__,___)=>ImageHelper.error(
                            width: 20,height: 20
                          ),
                          height: 20,
                          width: 20,
        ...
        Positioned(
          bottom: 0,
          right: 0,
          child: article.collect == null ? SizedBox.shrink()
                    : ArticleFavoriteWidget(article),
        ),
      ],
    );
  }
...
class ArticleFavoriteWidget extends StatelessWidget{
  ...
  final Article article;
  ArticleFavoriteWidget(this.article);
            ...
            child: Hero(
              ...
              child: ScaleAnimatedSwitcher(
                child: model.busy
                    ? SizedBox.shrink()
                  :Icon(
                  model.article.collect ? Icons.favorite : Icons
                      .favorite_border,
